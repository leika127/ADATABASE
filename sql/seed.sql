...
--
-- NOTE : ce fichier a été corrigé automatiquement (mots-clés SQL avaient
-- été altérés en français, guillemets typographiques, virgules
-- décimales). Les noms de table/colonne accentués ont été normalisés
-- sans accent (categorie, competence, adherente, telephone,
-- date_arrivee) — à vérifier contre migration_up.sql.
-- =====================================================================
...
INSERT INTO benevole (nom, prenom, telephone, date_arrivee) VALUES
  ...
  ('Guérin', 'Isabelle', '0656833113', CURRENT_DATE - 880),
