-- ============================================================
-- Qestion 1: Combien d'objets avons-nous reçus le mois dernier, et quel poids total ?
-- ============================================================
SELECT
...
-- ============================================================
-- Qestion 2: Quels objets sont actuellement en rayon, et depuis combien de temps ?
-- (date_statut correspond à la date du dernier changement de statut).
-- ============================================================
SELECT
    o.numero_etiquette,
    o.designation,
...
-- ============================================================
-- Qestion 3: Quelle catégorie se vend le mieux ? Laquelle rapporte le plus ?
-- ============================================================
-- Deux sous-questions distinctes : 
-- a. "se vend le mieux" = nombre de ventes,
-- b. "rapporte le plus" = somme des prix payés. Une seule requête, deux tris possibles.

-- a. Catégorie qui se vend le mieux (en nombre d'objets vendus)
SELECT
    o.categorie,
...
-- b. Catégorie qui rapporte le plus (en chiffre d'affaires)
SELECT
    o.categorie,
    COUNT(*)            AS nb_objets_vendus,
    SUM(o.prix_paye)    AS chiffre_affaires
...
-- ============================================================
-- Qestion 4: Combien d'heures de bénévolat ont été consacrées à la réparation cette année ?
-- ============================================================
SELECT
...
-- ============================================================
-- Qestion 5: Quel est le taux de réussite des réparations, par bénévole et globalement ?
-- ============================================================
...
-- ============================================================
-- Qestion 6: Quelles personnes nous ont fait plus de trois dépôts ?
-- ============================================================
SELECT
    p.id_personne,
    p.nom,
...
-- ============================================================
-- Qestion 7: Quel poids total avons-nous détourné de la déchetterie
...
-- ============================================================
-- Qestion 8: Quel est le taux de présence réelle sur nos ateliers ?
-- ============================================================
...
-- ============================================================
-- Qestion 9: Quels bénévoles ont la compétence « électricité » et sont disponibles
...
-- ============================================================
-- Qestion 10: Quels objets sont en rayon depuis plus de six mois et devraient être sortis ?
-- ============================================================
SELECT
    o.numero_etiquette,
    o.designation,
